package online.jlfsdtc.blog.controller;

import com.github.pagehelper.PageInfo;
import com.vdurmont.emoji.EmojiParser;
import online.jlfsdtc.blog.constant.WebConst;
import online.jlfsdtc.blog.dto.ErrorCode;
...
import online.jlfsdtc.blog.model.bo.CommentBo;
import online.jlfsdtc.blog.model.bo.RestResponseBo;
import online.jlfsdtc.blog.model.vo.*;
import online.jlfsdtc.blog.service.*;
import online.jlfsdtc.blog.utils.BlogsUtils;
import online.jlfsdtc.blog.utils.Commons;
import online.jlfsdtc.blog.utils.IPKit;
import online.jlfsdtc.blog.utils.PatternKit;
...
public class IndexController extends BaseController {
    ...
    public void logout(HttpSession session, HttpServletResponse response) {
        BlogsUtils.logout(session, response);
    }
    ...
    public RestResponseBo comment(HttpServletRequest request, HttpServletResponse response,
        ...
        if (StringUtils.isNotBlank(mail) && !BlogsUtils.isEmail(mail)) {
        ...
        author = BlogsUtils.cleanXSS(author);
        text = BlogsUtils.cleanXSS(text);
