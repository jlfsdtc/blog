...
import online.jlfsdtc.blog.dao.CommentVoMapper;
import online.jlfsdtc.blog.dao.ContentVoMapper;
import online.jlfsdtc.blog.dao.MetaVoMapper;
...
import online.jlfsdtc.blog.model.bo.ArchiveBo;
import online.jlfsdtc.blog.model.bo.BackResponseBo;
import online.jlfsdtc.blog.model.bo.StatisticsBo;
import online.jlfsdtc.blog.model.vo.*;
...
import online.jlfsdtc.blog.utils.ZipUtils;
import online.jlfsdtc.blog.utils.backup.Backup;
...
public class SiteServiceImpl implements ISiteService {
    ...
    public BackResponseBo backup(String bk_type, String bk_path, String fmt) throws Exception {
        ...
        if (bk_type.equals("attach")) {
            ...
            String fname = DateKit.dateFormat(new Date(), fmt) + "_" + BlogsUtils.getRandomNumber(5) + ".zip";
        ...
        if (bk_type.equals("db")) {
            ...
            String sqlFileName = "tale_" + DateKit.dateFormat(new Date(), fmt) + "_" + BlogsUtils.getRandomNumber(5) + ".sql";
            String zipFile = sqlFileName.replace(".sql", ".zip");

            Backup backup = new Backup(BlogsUtils.getNewDataSource().getConnection());
