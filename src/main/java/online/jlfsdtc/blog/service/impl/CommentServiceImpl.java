...
import online.jlfsdtc.blog.model.vo.CommentVoExample;
import online.jlfsdtc.blog.model.vo.ContentVo;
import online.jlfsdtc.blog.service.ICommentService;
...
public class CommentServiceImpl implements ICommentService {
    ...
    public String insertComment(CommentVo comments) {
        ...
        if (StringUtils.isNotBlank(comments.getMail()) && !BlogsUtils.isEmail(comments.getMail())) {
            return "请输入正确的邮箱格式";
        }
