...
import online.jlfsdtc.blog.dao.UserVoMapper;
import online.jlfsdtc.blog.exception.TipException;
import online.jlfsdtc.blog.model.vo.UserVo;
import online.jlfsdtc.blog.model.vo.UserVoExample;
...
//            用户密码加密
            String encodePwd = BlogsUtils.md5Encode(userVo.getUsername() + userVo.getPassword());
    ...
    public UserVo login(String username, String password) {
        ...
        String pwd = BlogsUtils.md5Encode(username + password);
