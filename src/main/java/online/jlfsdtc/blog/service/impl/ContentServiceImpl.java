...
import online.jlfsdtc.blog.model.vo.ContentVoExample;
import online.jlfsdtc.blog.service.IContentService;
import online.jlfsdtc.blog.service.IMetaService;
import online.jlfsdtc.blog.service.IRelationshipService;
import online.jlfsdtc.blog.utils.DateKit;
import online.jlfsdtc.blog.utils.BlogsUtils;
import online.jlfsdtc.blog.utils.Tools;
...
public class ContentServiceImpl implements IContentService {
    ...
    public String publish(ContentVo contents) {
        ...
        if (StringUtils.isNotBlank(contents.getSlug())) {
            ...
            if (!BlogsUtils.isPath(contents.getSlug())) return "您输入的路径不合法";
