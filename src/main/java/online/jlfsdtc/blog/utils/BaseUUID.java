...
public abstract class BaseUUID {
    ...
    private static final char[] F_UU64 = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".toCharArray();
    private static final char[] F_UU32 = "0123456789abcdefghijklmnopqrstuv".toCharArray();
    ...
    public static String uu32(UUID uu) {
        ...
        for (int i = 0; i < 13; i++) {
            sb.append(F_UU32[(int) (m >> ((13 - i - 1) * 5)) & 31]);
        }
        for (int i = 0; i < 13; i++) {
            sb.append(F_UU32[(int) (l >> ((13 - i - 1)) * 5) & 31]);
        }
        return sb.toString();
    }
    ...
    private static final char[] F_UU16 = "0123456789abcdef".toCharArray();
    ...
    public static String uu16fromUU64(String uu64) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            char cl = cs[off];
            char cr = cs[off + 1];
            int l = Arrays.binarySearch(F_UU64, cl);
            int r = Arrays.binarySearch(F_UU64, cr);
            int n = (l << 6) | r;
